...
4. **Create a new git branch** named `feature/<TASK_NAME>` before starting implementation, e.g., `git checkout -b feature/<TASK_NAME>`.
5. **Implement tasks sequentially** - Complete in order
6. **Create a pull request** to merge the branch into `develop` once task integration is complete.
